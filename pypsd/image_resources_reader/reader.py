...
from pypsd.image_resources_reader.color import read_color
from pypsd.image_resources_reader.exif import read_exif_data_1_resource
from pypsd.image_resources_reader.grid_guide_info import read_guide_resource_block
...
def read_single_resource_block(rblock: ResourceBlock):
...
def read_image_resources(buf: BinaryIO):
    for rblock in iter_resource_blocks(buf):
        read_single_resource_block(rblock)
